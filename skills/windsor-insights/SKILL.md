...
description: Report, rank, compare, and trend performance data from any of the 350+ sources connected to Windsor.ai - paid ads, organic social, web analytics, SEO, CRM, e-commerce, payments, accounting, and warehouses. Use when the user asks about spend, traffic, engagement, conversions, revenue, pipeline, or any metric from a connected account, or asks what Windsor.ai can do. Do not use to change anything, to connect an account, or to schedule exports - route those to the sibling skills.
---
